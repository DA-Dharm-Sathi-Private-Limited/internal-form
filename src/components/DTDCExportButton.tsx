                    ...
                    <div className="bg-white dark:bg-[#16161f] rounded-2xl shadow-xl w-full max-w-md p-6 border border-gray-200 dark:border-[#2a2a38] animate-in slide-in-from-bottom-4 zoom-in-95 duration-200">
                        <div className="flex justify-between items-center mb-5">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                                <span className="text-indigo-500 bg-indigo-50 dark:bg-indigo-900/30 p-1.5 rounded-lg">
                        ...
                        <div className="space-y-4 mb-6 text-sm">
                            <p className="text-gray-600 dark:text-gray-400">
                                Select the time range to export scheduled DTDC orders. This will generate a separate CSV for each origin warehouse.
                            </p>
