...
const HSN_CATEGORIES: HsnCategory[] = [
  {
    ...
    name: "Rudrakshas",
    description:
      "All Mukhi Rudrakshas, Rudraksha Malas, and other plant-based beads (like Tulsi Malas).",
  },
  {
    code: "05080010",
    name: "Gemstones and Raw Crystals",
    description:
      "Precious and semi-precious stones (Ruby, Sapphire, Coral, Pearls), Geodes, and raw crystal clusters.",
  },
  {
    code: "71179090",
    name: "Bracelets, Malas and Decorative Items",
    description:
      "Crystal bracelets (Amethyst, Pyrite, etc.), imitation jewelry, 7 Chakra items, and decorative crystal items (rollers, plates).",
  },
  {
    code: "83062990",
    name: "Vastu Metal",
    description:
      "Vastu items made of general base metals, iron, or mixed alloys (e.g., metal pyramids, basic statuettes).",
  },
  {
    code: "74198090",
    name: "Vastu Copper/Brass",
    description:
      "Premium Vastu items specifically made of copper or brass (e.g., Copper Yantras, Brass Tortoises).",
  },
  {
    code: "44209090",
    name: "Vastu Wooden",
    description:
      "Vastu items carved from wood (e.g., Wooden frames, Shriparni wood items).",
  },
  {
    code: "39269090",
    name: "Miscellaneous Goods",
    description:
      "Catch-all for physical items that don't fit above (e.g., resin items, plastic/acrylic stands, mixed-material novelties).",
  },
  {
    code: "999591",
    name: "Poojas and Services",
    description:
      "Astrological consultations, Puja services, and other spiritual services (SAC code).",
  },
  {
    code: "999799",
    name: "Miscellaneous Services",
    description:
      "Catch-all for any other non-physical service charges not covered elsewhere (SAC code).",
  },
  {
    code: "996812",
    name: "Shipping and Delivery Services",
    description:
      "Delivery charges, shipping, and Cash on Delivery (COD) services.",
  },
];
    ...
    <div className="line-item-row">
      ...
      <div className="line-item-fields">
        <div className="line-item-field line-item-name">
            ...
            onChange={(e) => {
              ...
              if (matched) {
                ...
                if (matched.hsn_or_sac) {
                  ...
                  updates.tax_id = getCorrectTaxId(
                    matched.hsn_or_sac,
                    isInterstate,
                  );
                }
          ...
          {item.name &&
            (item.zoho_item_id ? (
              <span className="line-item-badge line-item-badge--zoho">
                ✓ In Zoho
              </span>
            ) : (
              <span className="line-item-badge line-item-badge--new">
                ★ New product
              </span>
            ))}
        </div>
          ...
          <select
            ...
            title={
              item.zoho_item_id
                ...
                : (HSN_CATEGORIES.find((c) => c.code === item.hsn_or_sac)
                    ?.description ?? "Select HSN/SAC category")
            }
            onChange={(e) => {
        ...
        <div className="line-item-field line-item-carat">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              onChange(index, {
                carat_size:
                  raw === "" ? undefined : Math.round(Number(raw) * 100) / 100,
              });
            }}
          />
        </div>
        ...
        <div className="line-item-field line-item-qty">
          ...
          <input
            ...
            disabled={readOnlyAllExceptCostPrice}
            onChange={(e) =>
              onChange(index, { quantity: Number(e.target.value) || 0 })
            }
            required
          />
        </div>
        ...
        <div className="line-item-field line-item-price">
          ...
          <input
            ...
            placeholder="0.00"
            value={
              item.final_price !== undefined && item.final_price !== 0
                ? item.final_price
                : ""
            }
            disabled={readOnlyAllExceptCostPrice}
            ...
            onChange={(e) => {
              const raw = e.target.value;
              onChange(index, {
                final_price: raw === "" ? undefined : Number(raw),
              });
            }}
            required
          />
